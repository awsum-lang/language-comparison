 ...
 *
 * Java outcome (OpenJDK 25.0.3, Temurin, `java Main.java 5000000 1`): `java.lang.StackOverflowError`
 ...
 * accumulator runs as a chain of real stack frames. The depth-5_000_000 left
...
public class Main {
    public static void main(String[] args) {
        ...
        int mirrorCount = Integer.parseInt(args[1]);
        System.out.println(runDemo(treeDepth, mirrorCount));
    }

    static int runDemo(int treeDepth, int mirrorCount) {
