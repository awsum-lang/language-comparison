 ...
 *
 * Go outcome (go 1.26.4, `go run . 5000000 1`): Go does no tail-call elimination (the
...
func main() {
	...
	mirrorCount, _ := strconv.Atoi(os.Args[2])
	fmt.Println(runDemo(treeDepth, mirrorCount))
}

func runDemo(treeDepth, mirrorCount int) int {
